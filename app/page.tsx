  ...
  return (
    <>
      ...
      <div className="snap-y snap-mandatory">
        {/* PAGE 1 */}
        <section
          className="snap-start min-h-screen flex items-center justify-center px-5 text-center text-white"
          style={{
        ...
        >
          <div className="max-w-4xl rounded-3xl bg-black/55 p-6 backdrop-blur-sm md:p-10">
            <h1 className="text-3xl font-bold leading-tight md:text-7xl">
              Play Competitive & Social Tennis in Tokyo
            </h1>

            <p className="mt-5 text-base text-gray-200 md:text-xl">
            ...
            <a
              ...
              className="mt-8 inline-block rounded-full bg-white px-7 py-3 text-base font-semibold text-black transition hover:opacity-80"
            >
        ...
        {/* PAGE 2 */}
        <section className="snap-start min-h-screen flex items-center justify-center bg-white px-6">
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-2">
              <div className="rounded-2xl bg-gray-100 p-6">
                ...
                <p className="mt-3 text-gray-600">
                  Join our community and enjoy regular tennis events.
                </p>
              </div>
        ...
        {/* PAGE 3 */}
        <section className="snap-start min-h-screen flex items-center justify-center bg-gray-50 px-6">
          <div className="max-w-4xl text-center">
            ...
            <p className="mt-8 text-lg leading-8 text-gray-700">
              ...
              players through singles, doubles, team competitions, and tennis camps.
            </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-10 inline-block rounded-full bg-black px-8 py-4 text-lg font-semibold text-white transition hover:opacity-80"
            >
              Join Tokyo Tennis Club
            </a>
