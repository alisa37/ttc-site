  ...
  return (
    <>
      ...
      <main className="bg-white text-black md:h-screen md:snap-y md:snap-mandatory md:overflow-y-scroll">
        {/* HERO */}
        <section className="hero-section flex min-h-[100svh] items-center justify-center px-5 py-16 text-center text-white md:h-screen md:snap-start">
          <div className="w-full max-w-sm rounded-3xl bg-black/35 p-5 backdrop-blur-sm md:max-w-3xl md:bg-black/45 md:p-8">
