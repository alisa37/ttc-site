  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-black">
        {/* HERO */}
        <section
          className="flex min-h-screen items-center justify-center bg-cover bg-[position:70%_center] px-6 py-20 text-center text-white md:h-screen md:bg-center md:snap-start md:py-0"
          style={{
