...
export default function TennisInTokyoPage() {
  return (
    <>
      <Script id="tennis-in-tokyo-click-tracking" strategy="afterInteractive">
        {`
      ...
      <main className="min-h-screen bg-white text-black">
        <section className="mx-auto max-w-4xl px-6 py-20">
          ...
          <p className="mb-6 text-lg leading-8 text-gray-600 md:text-xl md:leading-9">
            Ariake Tennis Park is Japan&apos;s premier tennis venue and one of
            the most famous tennis facilities in the country. It regularly hosts
            major international tournaments and offers world-class courts,
          ...
          <ul className="mb-12 list-disc space-y-3 pl-6 text-lg leading-8 text-gray-600 md:text-xl md:leading-9">
            <li>
              ...
              <a
                ...
                data-ga-event="google_map_click"
                data-ga-category="Google Map"
                data-ga-label="Ariake Tennis Park"
          ...
          <p className="mb-6 text-lg leading-8 text-gray-600 md:text-xl md:leading-9">
            ...
            located and popular among expats, international visitors, and
            players staying in central Tokyo.
          </p>
          ...
          <p className="mb-6 text-lg leading-8 text-gray-600 md:text-xl md:leading-9">
            Azabu Tennis Courts are one of the most convenient tennis facilities
            in central Tokyo. Located near Hiroo, Azabu-juban, embassies,
            international schools, and Roppongi Hills, they attract both local
          ...
          <ul className="mb-14 list-disc space-y-3 pl-6 text-lg leading-8 text-gray-600 md:text-xl md:leading-9">
            <li>
              ...
              <a
                ...
                data-ga-event="google_map_click"
                data-ga-category="Google Map"
                data-ga-label="Azabu Tennis Courts"
                className="underline underline-offset-4 hover:text-black"
              >
          ...
          <p className="mb-6 text-lg leading-8 text-gray-600 md:text-xl md:leading-9">
            ...
            intermediate and advanced players. We organize regular doubles
            events, singles sessions, team competitions, tennis camps, and
            private tennis experiences throughout Tokyo.
          </p>
          ...
          <p className="mb-10 text-lg leading-8 text-gray-600 md:text-xl md:leading-9">
            Most events are conducted in English and bring together local
            players, expats, and visitors from around the world.
          </p>
          ...
          <div className="text-center">
            <a
              ...
              data-ga-label="Tennis in Tokyo Join Tokyo Tennis Club"
            ...
            <div className="mt-5">
              <Link
                ...
                data-ga-label="Tennis in Tokyo Back to Home"
